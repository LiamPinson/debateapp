...
export async function runTier1Analysis(topic, transcript) {
  ...
  try {
    ...
    // Placeholder for future AI voice detection — always false until feature is built
    result.pro_ai_voice_detected = false;
    result.con_ai_voice_detected = false;
    ...
    return {
      ...
      flagged_moments: [],
      pro_ai_voice_detected: false,
      con_ai_voice_detected: false,
