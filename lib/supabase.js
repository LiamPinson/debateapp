...
export function createBrowserClient() {
  ...
  // Seed Realtime WebSocket with the anon key so the handshake succeeds.
  // Without this, persistSession:false leaves accessToken as null and
  // every WebSocket connection attempt fails.
  _browserClient.realtime.setAuth(key);
