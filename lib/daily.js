...
const DAILY_DOMAIN = process.env.NEXT_PUBLIC_DAILY_DOMAIN || "dissensus.daily.co";
  ...
  const res = await fetch(`${DAILY_API_BASE}/meeting-tokens`, {
    ...
    body: JSON.stringify({
      properties: {
        ...
        exp,
        is_owner: isOwner,
        // Note: enable_recording is a room property, not a token property.
        // Recording is already configured at room creation time.
        start_audio_off: false,
